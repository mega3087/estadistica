<div class="theme-config">
    <div class="theme-config-box">
        <div class="spin-icon">
			<span class="badge badge-warning pull-right"><?php echo count($percepciones)+count($circulares)+count($recibos); ?></span>
			...
			<div class="ibox float-e-margin setings-item default-skin">
				...
				<div class="ibox-content" style="display: none;">
					...
					<div class="setings-item">
						...
						$PEClave = $this->encrypt->encode($val['PEClave']);
						$ruta = "percepciones/index/$PEClave/$accion/".rand(100000,10000000000);
						?>
						<a href="<?php echo base_url($ruta); ?>">
							<?php echo "Folio: [".folio($val['PEClave'])."] - ".$val['UNombre']; ?>
						</a>
					</div>
					<?php } ?>
				</div>
