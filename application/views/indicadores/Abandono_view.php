							...
							<tbody>
								...
								<tr>
									...
									<td><?php 
										...
										?> %</td>								
								<td>
									<button data-toggle="modal" href="#modal_abandono" 
										data-aidabandono_skip="<?php echo $list['AIdAbandono']; ?>"
										data-aperiodo="<?php echo $list['APeriodo']; ?>"
										data-ababs="<?php echo $list['ABABS']; ?>"
										data-aporcentaje="<?php echo $list['APorcentaje']; ?>"								
							...
							datasets: [
								{
									...
									fillColor: "rgba(204, 116, 53, 50)",
									strokeColor: "rgba(204, 116, 66, 50)",
									highlightFill: "rgba(133, 76, 35, 52)",
	...
	<div class="modal-dialog" >
		<div class="modal-content animated flipInY">
			...
			<div class="modal-header">
				...
				<h6 class="modal-title"><i class="fa fa-building-o"></i>&nbsp;&nbsp; Indicadores</h6>
			</div>
...
<div class="modal inmodal" id="modal_abandono" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" >
		<div class="modal-content animated flipInY">
			
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
				<h6 class="modal-title"><i class="fa fa-building-o"></i>&nbsp;&nbsp;Abandono Escolar</h6>
			</div>
			<div class="modal-content">
				<?php echo form_open('indicadores/save_abandono', array('name' => 'Formabandono', 'id' => 'Formabandono', 'role' => 'form', 'class' => 'form-horizontal panel-body')); ?>
				<div class="form-group">
					<label class="col-lg-3 control-label" for="">CICLO:<em>*</em></label>
					<div class="col-lg-9">
						<input type="text" id="APeriodo" name="APeriodo" value="" maxlength='150' class="form-control uppercase"/>
					</div>
				</div>	
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" id="ABABS" name="ABABS" value="" maxlength='150' class="form-control uppercase"/>
					</div>
				</div>	
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" id="APorcentaje" name="APorcentaje" value="" maxlength='150' class="form-control uppercase"/>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-lg-offset-3 col-lg-9">
						<?php if( is_permitido(null,'plantel','save') ){ ?>
						<input type="hidden" id="AIdAbandono_skip" name="AIdAbandono"/>
						<button type="submit" class="btn btn-primary pull-right"> <i class="fa fa-save"></i> Guardar</button>
						<?php } ?>
					</div>
				</div>
...
<div class="modal inmodal" id="modal_agregar" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" >
		<div class="modal-content animated flipInY">
			...
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
				<h6 class="modal-title"><i class="fa fa-building-o"></i>&nbsp;&nbsp;Abandono Escolar1</h6>
			</div>
			<div class="modal-content">
				<?php echo form_open('indicadores/agregar_abandono', array('name' => 'Formagregar_abandono', 'id' => 'Formagregar_abandono', 'role' => 'form', 'class' => 'form-horizontal panel-body')); ?>
				<div class="form-group">
					<label class="col-lg-3 control-label" for="">CICLO:<em>*</em></label>
					<div class="col-lg-9">
						<input type="text" id="APeriodoA" name="APeriodo" value="" maxlength='150' class="form-control uppercase"/>
					</div>
				</div>				
				...
				<div class="form-group">
					<label class="col-lg-3 control-label" for="">Porcentaje: <em>*</em></label>
					<div class="col-lg-9">
						<input type="text" id="APorcentajeA" name="APorcentaje" value="" maxlength='150' class="form-control uppercase"/>
					</div>
				</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(document).on("click", ".open", function () {
			$(".modal-content #AIdAbandono_skip").val( $(this).data('aidabandono_skip') );
			$(".modal-content #APeriodo").val( $(this).data('aperiodo') );
			$(".modal-content #ABABS").val( $(this).data('ababs') );
			$(".modal-content #APorcentaje").val( $(this).data('aporcentaje') );
		});

		$("#Formabandono").submit(function(e) {
			e.preventDefault();
			$.ajax({
				type: "POST",
				url: "<?php echo base_url("indicadores/save_abandono"); ?>",
				data: $(this).serialize(),
				dataType: "html",
				beforeSend: function(){
		...
		$("#Formagregar_abandono").submit(function(e) {
			e.preventDefault();
			$.ajax({
				type: "POST",
				url: "<?php echo base_url("indicadores/agregar_abandono"); ?>",
				data: $(this).serialize(),
				dataType: "html",
				beforeSend: function(){
					$(".loading").html("<div class=\"spiner-example\"><div class=\"sk-spinner sk-spinner-three-bounce\"><div class=\"sk-bounce1\"></div><div class=\"sk-bounce2\"></div><div class=\"sk-bounce3\"></div></div></div>");
