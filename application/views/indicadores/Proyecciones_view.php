					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover dataTables-example- dataTable" >
							...
							<tbody>
								...
								<tr>
									<td><?=$list['PMPeriodo']?></td>
									<td><?=$list['PMTotal']?></td>
									<td>
									<button data-toggle="modal" href="#modal_proyecciones" 
										data-pmidproyeccion_skip="<?php echo $list['PMIdProyeccion']; ?>"
										data-pmperiodo="<?php echo $list['PMPeriodo']; ?>"
										data-pmtotal="<?php echo $list['PMTotal']; ?>"								
...
<!--*************** Modal Proyección de Matrícula ********************* -->

<div class="modal inmodal" id="modal_proyecciones" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" >
		<div class="modal-content animated flipInY">
			
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
				<h6 class="modal-title"><i class="fa fa-building-o"></i>&nbsp;&nbsp;Proyección de Matrícula</h6>
			</div>
			<div class="modal-content">
				<?php echo form_open('indicadores/save_proyecciones', array('name' => 'Formproyecciones', 'id' => 'Formproyecciones', 'role' => 'form', 'class' => 'form-horizontal panel-body')); ?>
				<div class="form-group">
					<label class="col-lg-3 control-label" for="">CICLO:<em>*</em></label>
					<div class="col-lg-9">
						<input type="text" id="PMPeriodo" name="PMPeriodo" value="" maxlength='150' class="form-control uppercase"/>
					</div>
				</div>				
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" id="PMTotal" name="PMTotal" value="" maxlength='150' class="form-control uppercase"/>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-lg-offset-3 col-lg-9">
						<?php if( is_permitido(null,'plantel','save') ){ ?>
						<input type="hidden" id="PMIdProyeccion_skip" name="PMIdProyeccion"/>
						<button type="submit" class="btn btn-primary pull-right"> <i class="fa fa-save"></i> Guardar</button>
						<?php } ?>
					</div>
				</div>
...
<!-- ******************* FIN Modal Proyección de Matrícula ********************* -->
<!-- ******************* Modal Agregar ********************* -->
...
<div class="modal inmodal" id="modal_agregar" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" >
		<div class="modal-content animated flipInY">
			...
			<div class="modal-content">
				<?php echo form_open('indicadores/agregar_proyecciones', array('name' => 'Formagregar_proyecciones', 'id' => 'Formagregar_proyecciones', 'role' => 'form', 'class' => 'form-horizontal panel-body')); ?>
				<div class="form-group">
					<label class="col-lg-3 control-label" for="">Período:<em>*</em></label>
					<div class="col-lg-9">
						<input type="text" id="PMPeriodoA" name="PMPeriodo" value="" maxlength='150' class="form-control uppercase"/>
					</div>
				</div>				
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" id="PMTotalA" name="PMTotal" value="" maxlength='150' class="form-control uppercase"/>
					</div>
				</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(document).on("click", ".open", function () {
			$(".modal-content #PMIdProyeccion_skip").val( $(this).data('pmidproyeccion_skip') );
			$(".modal-content #PMPeriodo").val( $(this).data('pmperiodo') );
			$(".modal-content #PMTotal").val( $(this).data('pmtotal') );
		});

		$("#Formproyecciones").submit(function(e) {
			e.preventDefault();
			$.ajax({
				type: "POST",
				url: "<?php echo base_url("indicadores/save_proyecciones"); ?>",
				data: $(this).serialize(),
				dataType: "html",
				beforeSend: function(){
