					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover dataTables-example- dataTable" >
							...
							<tbody>
								...
								<td><button data-toggle="modal" href="#modal_aprobacion" 
								data-aidaprobados_skip="<?php echo $list['AIdAprobados']; ?>"
								data-aperiodo="<?php echo $list['APeriodo']; ?>"
								data-aabs="<?php echo $list['AABS']; ?>"
...
<div class="modal inmodal" id="modal_aprobacion" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" >
		<div class="modal-content animated flipInY">
			
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
				<h6 class="modal-title"><i class="fa fa-building-o"></i>&nbsp;&nbsp;Aprobación Ordinaria</h6>
			</div>
			<div class="modal-content">
				<?php echo form_open('indicadores/save_aprobacion', array('name' => 'Formaprobados', 'id' => 'Formaprobados', 'role' => 'form', 'class' => 'form-horizontal panel-body')); ?>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" id="AABS" name="AABS" value="" maxlength='150' class="form-control uppercase"/>
					</div>
				</div>				
				...
				<div class="form-group">
					<div class="col-lg-offset-3 col-lg-9">
						<?php if( is_permitido(null,'plantel','save') ){ ?>
						<input type="hidden" id="AIdAprobados_skip" name="AIdAprobados"/>
						<button type="submit" class="btn btn-primary pull-right"> <i class="fa fa-save"></i> Guardar</button>
						<?php } ?>
					</div>
				</div>
...
<div class="modal inmodal" id="modal_agregar" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" >
		<div class="modal-content animated flipInY">
			...
			<div class="modal-content">
				<?php echo form_open('indicadores/agregar_aprobacion', array('name' => 'Formagregar_aprobacion', 'id' => 'Formagregar_aprobacion', 'role' => 'form', 'class' => 'form-horizontal panel-body')); ?>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-lg-3 control-label" for="">ABS: <em>*</em></label>
					<div class="col-lg-9">
						<input type="text" id="AABSA" name="AABS" value="" maxlength='150' class="form-control uppercase"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-lg-3 control-label" for="">Porcentaje: <em>*</em></label>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(document).on("click", ".open", function () {
			$(".modal-content #AIdAprobados_skip").val( $(this).data('aidaprobados_skip') );
			$(".modal-content #APeriodo").val( $(this).data('aperiodo') );
			$(".modal-content #AABS").val( $(this).data('aabs') );
			$(".modal-content #APorcentaje").val( $(this).data('aporcentaje') );
			
		});

		$("#Formaprobados").submit(function(e) {
			e.preventDefault();
			$.ajax({
				type: "POST",
				url: "<?php echo base_url("indicadores/save_aprobacion"); ?>",
				data: $(this).serialize(),
				dataType: "html",
				beforeSend: function(){
		...
		$("#Formagregar_aprobacion").submit(function(e) {
			e.preventDefault();
			$.ajax({
				type: "POST",
				url: "<?php echo base_url("indicadores/agregar_aprobacion"); ?>",
				data: $(this).serialize(),
				dataType: "html",
				beforeSend: function(){
					$(".loading").html("<div class=\"spiner-example\"><div class=\"sk-spinner sk-spinner-three-bounce\"><div class=\"sk-bounce1\"></div><div class=\"sk-bounce2\"></div><div class=\"sk-bounce3\"></div></div></div>");
