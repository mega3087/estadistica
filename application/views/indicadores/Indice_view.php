...
<div class="row">
	<div class="ibox float-e-margins">
		<div class="ibox-content">
			<h3>Índice de Atención a la Demanda (Absorción)</h3>
		</div>
	</div>
</div>
<div class="row">
				...
				<div class="ibox-content">
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover dataTables-example- dataTable" >
							...
							<tbody>
								<?php foreach($indice as $key => $list ){ ?>
								<tr>
									<td><?=$list['IAPeriodo']?></td>
									<td><?=$list['IATotal']?></td>
									
								<td><button data-toggle="modal" href="#modal_indice" 
								data-iaidindice_skip="<?php echo $list['IAIdIndice']; ?>"
								data-iaperiodo="<?php echo $list['IAPeriodo']; ?>"
								data-iatotal="<?php echo $list['IATotal']; ?>"								
...
<div class="modal inmodal" id="modal_indice" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" >
		<div class="modal-content animated flipInY">
			
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
				<h6 class="modal-title"><i class="fa fa-building-o"></i>&nbsp;&nbsp;Índice de Atención a la Demanda (Absorción)</h6>
			</div>
			<div class="modal-content">
				<?php echo form_open('indicadores/save_indice', array('name' => 'Formindiceatencion', 'id' => 'Formindiceatencion', 'role' => 'form', 'class' => 'form-horizontal panel-body')); ?>
				<div class="form-group">
					<label class="col-lg-3 control-label" for="">CICLO:<em>*</em></label>
					<div class="col-lg-9">
						<input type="text" id="IAPeriodo" name="IAPeriodo" value="" maxlength='150' class="form-control uppercase"/>
					</div>
				</div>					
				<div class="form-group">
					<label class="col-lg-3 control-label" for="">ÍNDICE: <em>*</em></label>
					<div class="col-lg-9">
						<input type="text" id="IATotal" name="IATotal" value="" maxlength='150' class="form-control uppercase"/>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-lg-offset-3 col-lg-9">
						<?php if( is_permitido(null,'indicadores','save_indice') ){ ?>
						<input type="hidden" id="IAIdIndice_skip" name="IAIdIndice"/>
						<button type="submit" class="btn btn-primary pull-right"> <i class="fa fa-save"></i> Guardar</button>
						<?php } ?>
					</div>
				</div>
...
<div class="modal inmodal" id="modal_agregar" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" >
		<div class="modal-content animated flipInY">
			...
			<div class="modal-content">
				<?php echo form_open('indicadores/agregar_indice', array('name' => 'Formagregar_indice', 'id' => 'Formagregar_indice', 'role' => 'form', 'class' => 'form-horizontal panel-body')); ?>
				<div class="form-group">
					<label class="col-lg-3 control-label" for="">Período:<em>*</em></label>
					<div class="col-lg-9">
						<input type="text" id="IAPeriodoA" name="IAPeriodo" value="" maxlength='9' placeholder="2010-2011" class="form-control uppercase"/>
					</div>
				</div>				
				...
				<div class="form-group">
					<label class="col-lg-3 control-label" for="">Índice: <em>*</em></label>
					<div class="col-lg-9">
						<input type="text" id="IATotalA" name="IATotal" value="" maxlength='150' class="form-control uppercase"/>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-lg-offset-3 col-lg-9">
						<?php if( is_permitido(null,'indicadores','agregar_indice') ){ ?>
							<button type="submit" class="btn btn-primary pull-right"> <i class="fa fa-save"></i> Guardar</button>
						<?php } ?>
					</div>
				</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(document).on("click", ".open", function () {
			$(".modal-content #IAIdIndice_skip").val( $(this).data('iaidindice_skip') );
			$(".modal-content #IAPeriodo").val( $(this).data('iaperiodo') );
			$(".modal-content #IATotal").val( $(this).data('iatotal') );
		});

		$("#Formindiceatencion").submit(function(e) {

			e.preventDefault();
			$.ajax({
				type: "POST",
				url: "<?php echo base_url("indicadores/save_indice"); ?>",
				data: $(this).serialize(),
				dataType: "html",
				beforeSend: function(){
		...
		$("#Formagregar_indice").submit(function(e) {
					e.preventDefault();
					$.ajax({
						type: "POST",
						url: "<?php echo base_url("indicadores/agregar_indice"); ?>",
						data: $(this).serialize(),
						dataType: "html",
						beforeSend: function(){
							$(".loading").html("<div class=\"spiner-example\"><div class=\"sk-spinner sk-spinner-three-bounce\"><div class=\"sk-bounce1\"></div><div class=\"sk-bounce2\"></div><div class=\"sk-bounce3\"></div></div></div>");
